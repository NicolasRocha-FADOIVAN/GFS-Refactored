...
include 'view/tela-principal/components.php';
...
<head>
    ...
    <link rel="stylesheet" href="view/tela-principal/tela principal.css" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="produtos-card-container">
            ...
            <?php recommendedProducts($list[1], $list[2], $list[3], $list[4]) ?>
            <?php endforeach ?>
